...
"""Generate the bounded deterministic More Red gallery."""
    ...
    for placement in cases.PLACEMENTS:
        lines.extend(
            (
                ...
                f"setblock {placement.x} {placement.y - 1} {placement.z} "
                "minecraft:stone",
...
def base_files() -> dict[Path, bytes]:
    ...
    return {
        ...
        Path("datapack/pack.mcmeta"): json_bytes(
            {
                "pack": {
                    "description": "ATM 1.2.0 More Red visual gallery",
                    "pack_format": 48,
                }
            }
        ),
        ...
        function_root / "load.mcfunction": text_bytes(
            "# Generated by gallery/generate.py; do not edit.\n"
            "tellraw @a {\"text\":\"More Red gallery loaded; "
