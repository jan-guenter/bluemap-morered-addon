...
| BlueMap Add-on Adapter API | `0.1.0-alpha.2` / `e81f08bc4bfbf02d810ec8949a019130e2e61634` | MIT | Four exact source-compiled helpers | Production classes and sources only |
| More Red profile | `morered-1.21.1-6.0.0.3` | See `provenance/upstreams.json` | Exact installed-artifact and resource evidence only | No |
